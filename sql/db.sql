...
ADD
    CONSTRAINT fk_trans_merch FOREIGN KEY(merchant_id) REFERENCES merchant (merchant_id);

ALTER TABLE transactions
ADD
    CONSTRAINT fk_trans_cart_hold FOREIGN KEY(cart_holder_id) REFERENCES cart_holder (cart_holder_id);
